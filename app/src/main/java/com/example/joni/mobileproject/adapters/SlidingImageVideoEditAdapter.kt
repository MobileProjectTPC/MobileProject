...
class SlidingImageVideoEditAdapter(var context: Context, private val imageVideoArrayList: ArrayList<ImageVideo>) : PagerAdapter() {
    ...
    override fun instantiateItem(view: ViewGroup, position: Int): Any {
        val imageLayout = inflater.inflate(R.layout.slidingimagesvideos_layout_edit, view, false)!!
        ...
        imageLayout.setOnClickListener {
            ...
            builder.setTitle("Delete entry")
                    .setMessage("Are you sure you want to delete this entry? It cannot be undone!")
